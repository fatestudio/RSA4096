...
if { [catch {open "|vsim -version" } input] } {
	...
	if { $is_altera } {
		...
		# A Verilog convert_hex2ver task is included in the altera_mf_ver precompiled library shipped with 
		# Modelsim-Altera and is used to convert the HEX memory into a Verilog memory file for simulation
		# Perform simulation using the precompiled altera_mf libraries
		vsim -L altera_mf_ver work.rom_vlg_vec_tst
	} else {
