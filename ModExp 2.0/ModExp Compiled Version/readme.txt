...
1. How to compile?
	...
	1.5. Click Processing -> Start Compilation. It takes a long time to finish compilation;
	1.6  Set the pin planner following ModExp-Input Pins.rpt and ModExp-Output Pins.rpt and compile the project again (if don't set the pins will be random).
